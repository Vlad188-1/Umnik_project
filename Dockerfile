...
RUN sudo apt update && sudo apt install -y libgl1-mesa-glx libpci3 libasound2 \
    ...
    libxi-dev libxkbcommon-dev libxkbcommon-x11-dev libglib2.0-0 libfontconfig1 libdbus-1-3 \
     libsm6 libxext6 gcc wget
...
RUN cd /home/vlad && wget https://repo.anaconda.com/miniconda/Miniconda3-latest-Linux-aarch64.sh \
    && chmod +x Miniconda3-latest-Linux-aarch64.sh \
    && ./Miniconda3-latest-Linux-aarch64.sh -b -p /home/vlad/miniconda3 \
